...
const [modo, setModo] = useState("E-SERVICE")
    ...
    return(
     <section>
       ...
       {modo == "E-SERVICE" ?
       <div className="text-3xl   border border-transparent">
       <div className="mt-40 p-4">
       <h1 className="text-6xl my-2">E-Service</h1>
       ...
       <h1 className="mt-12 text-6xl">GARANTIA</h1>
       <h2 className="mt-12 text-4xl"> Productos VeloMAX</h2>
      <h2 className="mt-10 text-3xl">Todos los motovehiculos fabricados o importados por VeloMAX presentan la siguiente garantía</h2>
      <FontAwesomeIcon className="text-6xl mt-10" icon={faMotorcycle} />
      <p className="mt-2">6 meses <br/> o 6.000 km.</p>
     
       </div>  
       }
       <button className="hover:border-white bg-blue-800  mt-10 mr-10 p-2 text-4xl border border-blue-800 rounded-md"
       onClick={handleState}>E-SERVICE</button>
       <button className="text-4xl p-2 hover:border-white bg-blue-800  border border-blue-800 rounded-md" 
