...
<Link to="/"><h1 className="hidden md:inline-flex text-6xl hover:text-blue-800 mx-3.5 mt-1.5 font-['Faster_One','cursive']">VeloMAX</h1></Link>
<button onClick={handleDisplay} id="nav-display" className="  bg-white z-20 h-fit mt-3 py-3 px-4 border rounded-lg border-black hover:border-blue-800 mr-24 cursor-pointer lg:hidden">
...
<ul id="mobile-nav" className=" z-10 hidden absolute sm:left-0 md:left-[36%]  h-max w-fit flex-col border border-black bg-white  rounded-md lg:hidden">
